        ...
        <div className="container">
          <div className="top-section">
            <div className="left">
              <p className="about__subheading">
                Hi, I am <span>Vishal Vishwakarma</span>
              </p>
              <h2 className="about__heading">Full Stack Developer</h2>
              <div className="about__info">
                <PText>
                  I am from Mumbai, Maharashtra . A place of beauty and nature.
          ...
          <div className="about__info__items">
            <div className="about__info__item">
              ...
              <AboutInfoItem
                title="S.S.C."
                items={['A.V.M. High School, Malad, Mumbai']}
              />
              <AboutInfoItem
                title="H.S.C."
                items={['Durgadevi Saraf Jr. College Malad, Mumbai']}
              />
              <AboutInfoItem
                title="B.C.A."
                items={['University Of Nashik (DE)']}
              />
            </div>
            <div className="about__info__item">
